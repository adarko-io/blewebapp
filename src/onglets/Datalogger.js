...
const WriteDataLoggerSize = async (z) => {
  ...
  async function onNotifyButtonClick() {
    ...
    if (notifStatus === "Notify OFF") {
      ...
      createLogElement(notifyCharacteristic, 3, "Datalogger ENABLE NOTIFICATION");
      ...
      createLogElement(notifyCharacteristic, 3, "Datalogger DISABLE NOTIFICATION");
      console.log(notifyCharacteristic.characteristic);
    }
  }
          ...
          <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 p-3 border mx-2 my-2">
            <form id="deviceConfigForm" onSubmit={handleFormSubmit}>
              ...
              {dataloggerType === '1' && (
                <>
                  <div className="mb-3 row align-items-center">
                    <label htmlFor="accumulatedFlowInput" className="col-sm-4 col-form-label text-start">Accumulated Flow</label>
                    <div className="col-sm-8">
                      <input type="text" className="form-control" id="accumulatedFlowInput" placeholder="Enter Accumulated Flow" required disabled value={accumulatedFlow} onChange={e => setAccumulatedFlow(e.target.value)} />
                    </div>
                  </div>

                  <div className="mb-3 row align-items-center">
                    <label htmlFor="forwardFlowInput" className="col-sm-4 col-form-label text-start">Forward Flow</label>
                    <div className="col-sm-8">
                      <input type="text" className="form-control" id="forwardFlowInput" placeholder="Enter Forward Flow" required disabled={!isActivated} value={forwardFlow} onChange={e => setForwardFlow(e.target.value)} />
                    </div>
                  </div>

                  <div className="mb-3 row align-items-center">
                    <label htmlFor="reverseFlowInput" className="col-sm-4 col-form-label text-start">Reverse Flow</label>
                    <div className="col-sm-8">
                      <input type="text" className="form-control" id="reverseFlowInput" placeholder="Enter Reverse Flow" required disabled={!isActivated} value={reverseFlow} onChange={e => setReverseFlow(e.target.value)} />
                    </div>
                  </div>
